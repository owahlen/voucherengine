# Voucherify – Cascade Delete Behavior
...
✅ Deleting a product deletes its SKUs  
❌ Deleting a SKU does not delete its product  
...
| Redemption | — (immutable) | Everything |
| Order | — | Everything |
| Product | SKUs | Orders, Vouchers |
| SKU | — | Product, Orders, Vouchers |
...
### When *not* to delete
- If you only want to stop issuance → deactivate the campaign
- If you need auditability → never delete redemptions

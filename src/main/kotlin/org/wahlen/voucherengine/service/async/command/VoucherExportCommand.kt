...
import org.wahlen.voucherengine.service.VoucherExportService
import java.util.*

/**
 * Command for exporting vouchers asynchronously via SQS.
 */
data class VoucherExportCommand(
    ...
    override fun toAsyncJob(tenant: Tenant): AsyncJob {
        return AsyncJob(
            type = AsyncJobType.VOUCHER_EXPORT,
    ...
    override fun execute(context: ApplicationContext) {
        val exportService = context.getBean(VoucherExportService::class.java)

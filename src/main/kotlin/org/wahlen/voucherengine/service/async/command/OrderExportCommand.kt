...
import org.wahlen.voucherengine.service.OrderExportService
import java.util.*

/**
 * Command for exporting orders asynchronously via SQS.
 */
data class OrderExportCommand(
    ...
    override fun toAsyncJob(tenant: Tenant): AsyncJob {
        return AsyncJob(
            type = AsyncJobType.ORDER_EXPORT,
    ...
    override fun execute(context: ApplicationContext) {
        val exportService = context.getBean(OrderExportService::class.java)
